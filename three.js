  ...
  AFRAME.registerComponent("backward1", {
    init: function () {
      ...
      <a-sky src="./source/entrance-1.jpg" rotation="0 -90 0"></a-sky>
          ...
          <a-entity id="three" gltf-model="#three" position="-5.522 2.350 -0.950" rotation = "0 74.817 0"scale="2 2 2" class="raycastable"teleport2></a-entity>
          <a-entity id="next" gltf-model="#next" position="9.134 2.350 -4.397" rotation = "0 -90.432 0"scale="4 4 4" class="raycastable"></a-entity>
